...
func (h *HandlerImpl) GetItinerary(w http.ResponseWriter, r *http.Request) {
	...
	itinerary, err := h.llmInteractionService.GetItinerary(ctx, userID, itineraryID)
	if err != nil {
...
func (h *HandlerImpl) GetItineraries(w http.ResponseWriter, r *http.Request) {
	...
	paginatedResponse, err := h.llmInteractionService.GetItineraries(ctx, userID, page, pageSize)
	if err != nil {
...
func (h *HandlerImpl) UpdateItinerary(w http.ResponseWriter, r *http.Request) {
	...
	updatedItinerary, err := h.llmInteractionService.UpdateItinerary(ctx, userID, itineraryID, req)
	if err != nil {
